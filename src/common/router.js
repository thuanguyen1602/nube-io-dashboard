...
export const getRouterData = app => {
  const routerConfig = {
    ...
    '/gas': {
      component: dynamicWrapper(app, ['electrical'], () => import('../routes/Gas')),
    },
    '/thermal': {
      component: dynamicWrapper(app, ['electrical'], () => import('../routes/Thermal')),
    },
    '/apartments': {
      component: dynamicWrapper(app, ['apartments'], () => import('../routes/Apartments')),
    },
    '/trends': {
      component: dynamicWrapper(app, ['electrical'], () => import('../routes/Trends')),
    },
    '/alerts': {
      component: dynamicWrapper(app, ['electrical'], () => import('../routes/Alerts')),
    },
    '/settings': {
      component: dynamicWrapper(app, ['electrical'], () => import('../routes/Settings')),
    },
    '/user': {
